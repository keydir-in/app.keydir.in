...
/**
 * Animated external-link icon (window + out arrow). On hover the arrow
 * nudges up-right and the window box slightly shrinks. Stroke scaled from
 * a 24-unit basis to the 24-unit viewBox.
 */
