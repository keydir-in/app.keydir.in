...
/**
 * Animated electric truck icon. Drives right and fades out on hover, then
 * slides back in from the left and settles. Stroke scaled from a 24-unit
 * basis to the 24-unit viewBox.
 */
